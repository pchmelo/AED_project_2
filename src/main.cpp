...
/*
    auto scr = flights.flights.findVertex(Airports("PTJ"));
    auto dest = flights.flights.findVertex(Airports("YHO"));

    int num = 0;
    auto res = flights._11AllBestPathEntreDoisAeroportos(scr, dest, {}, 0);
